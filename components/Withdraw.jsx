            ...
            <div className="  flex-col flex gap-6">
                <div className="flex justify-center flex-col ">
                    <div className=" flex flex-col gap-2 items-center">
                        <p className=" flex items-center text-[#3a89b4] p-6">Bakiye: &nbsp;  <p className=" flex font-OpenSans font-thin text-[#222]">{Number(companyInfo[3]) / (10**16)} DTL</p></p>
                        <div className="  w-full ">
                            <div className=" border-t-2 border-[#4284be] flex items-center justify-center bg-[#4284be]/10 h-full min-h-[120px] rounded-b-xl">
                                <div className=" bg-[#3b77ac] h-min p-0.5  rounded-full text-[#fff]">
                                    <button onClick={withdraw} className=" border-t border-[#5d93c2]  rounded-full p-2 px-5  font-OpenSans flex flex-row items-center">Hesaba Para Cek</button>
                                </div>
                            </div>
                        </div>
                    </div>
