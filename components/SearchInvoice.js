                ...
                >
                  ...
                  <div className=' mx-10 mt-10 min-w-[1100px] max-w-[1300px] max-h-[700px] overflow-y-auto flex-col flex'>
                        <div className='flex-row w-full flex justify-between gap-6'>
                                <div className=' text-black/70 font-OpenSans'>
                                        <div className=' border-y-4 border-black max-w-[400px]'>
                                            ...
                                            <p>Sirket Cuzdan Adresi:0x08e2922D0773F1969fB1D29b08D564B8b34b992a</p>
                                            <p>VKN: 124123123321</p>
                                            <p>Sirket Adresi: Medine mekke arasinda bir yerde belki bucada belki alsancakta</p>
                                        </div>
                        ...
                        <div className=' h-full w-full mx-auto mt-10'>
                                ...
                                <p className=' ml-2 font-bold text-black/70 flex flex-row'>Not: &nbsp; <p className=' font-medium t'> Odenecek tutar #***********#</p></p>
                                    <p className=' ml-2 font-bold text-black/70 flex flex-row'>Not: &nbsp; <p className=' font-medium'> e-Arsiv izni kapsaminda blockchain ortaminda hazirlanmistir.</p></p>
                                </div>            
                            </div>        
