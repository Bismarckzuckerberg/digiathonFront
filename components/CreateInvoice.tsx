          ...
          <div className=" m-4 flex-col flex gap-6">
            <div className="flex justify-center flex-col ">
              ...
              <p className=" px-10 pb-5 mb-4 text-sm font-OpenSans">
                Bu sayfa üzerinde yetkili şirketler verdikleri hizmetler
                karşılığı fatura kişinin cüzdan adresine fatura kesebilir.
              </p>
            </div>
                ...
                <form className="flex-col flex gap-6">
                  <div>
                    <p className=" flex font-OpenSans font-thin text-[#222]">
                      <p className=" text-[#3a89b4]">*</p>TC kimlik no veya KV
                      no
                    </p>
                    <input
                      type="text"
                    ...
                    <p className=" font-OpenSans font-extralight text-sm text-[#4a4e50]">
                      Fatura kesilenin TC kimlik nosu veyahut KV nosunu giriniz.
                    </p>
                  </div>
                  <div>
                    <p className=" flex font-OpenSans font-thin text-[#222]">
                      <p className=" text-[#3a89b4]">*</p>Fatura Adı
                    </p>
                    <input
                      type="text"
                      className="border border-[#a8acae] w-full rounded-sm max-w-[700px]"
                    ...
                    />
                    <p className=" font-OpenSans font-extralight text-sm text-[#4a4e50]">
                      Faturanın adını giriniz.
                    </p>
                  </div>
                  <div>
                    <p className=" flex font-OpenSans font-thin text-[#222]">
                      <p className=" text-[#3a89b4]">*</p>Fatura Kesilecek Adres
                    </p>
                    <input
                      type="text"
                      className="border border-[#a8acae] w-full rounded-sm max-w-[700px]"
                    ...
                    />
                    <p className=" font-OpenSans font-extralight text-sm text-[#4a4e50]">
                      Faturanın kesildiği adresi giriniz.
                    </p>
                  </div>
                  <div>
                    <p className=" flex font-OpenSans font-thin text-[#222]">
                      <p className=" text-[#3a89b4]">*</p>Fatura Açıklaması
                    </p>
                    <input
                      type="text"
                      className="border border-[#a8acae] w-full rounded-sm max-w-[700px]"
                    ...
                    />
                    <p className=" font-OpenSans font-extralight text-sm text-[#4a4e50]">
                      Fatura için açıklama giriniz.
                    </p>
                  </div>
                  <div>
                    <p className=" flex font-OpenSans font-thin text-[#222]">
                      <p className=" text-[#3a89b4]">*</p>Ücret
                    </p>
                    <input
                      type="text"
                      className="border border-[#a8acae] w-full rounded-sm max-w-[700px]"
                    ...
                    />
                    <p className=" font-OpenSans font-extralight text-sm text-[#4a4e50]">
                      Fiyat/Hizmet bedeli giriniz.
                    </p>
                  </div>
                  <div>
                    <p className=" flex font-OpenSans font-thin text-[#222]">
                      <p className=" text-[#3a89b4]">*</p>Vergi Oranı
                    </p>
                    <input
                      type="text"
                      className="border border-[#a8acae] w-full rounded-sm max-w-[700px]"
